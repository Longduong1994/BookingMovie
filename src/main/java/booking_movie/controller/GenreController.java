...
public class GenreController {
    ...
    @GetMapping
    public ResponseEntity<Page<GenreResponseDto>> getAllGenre(@RequestParam(required = false) String search,
                                                              @PageableDefault(size = 2, page = 0, sort = "genreName") Pageable pageable) {
    ...
    @PutMapping("/{idEdit}")
    public ResponseEntity<GenreResponseDto> updateGenre(@PathVariable Long idEdit,@RequestBody GenreRequestDto genreRequestDto) throws GenreException {
